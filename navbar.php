...
<ul class="nav">
  ...
  <li class="nav-item">
    <a class="nav-link active" href="./registration_form.php">Register</a>
  </li>
    
  <li class="nav-item">
    <a class="nav-link" href="./signin_form.php">SignIn</a>
  </li> 
  ...
  <li class="nav-item">
    <a class="nav-link" href="./autoloading/index.php">namespaces</a>
  </li>
  <li class="nav-item">
